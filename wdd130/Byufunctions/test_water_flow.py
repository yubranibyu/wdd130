...
def test_pressure_loss_from_pipe():
    ...
    assert pressure_loss_from_pipe(0.048692, 200.00, 0.018, 0.0,) == approx(0.000, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 200.00, 0.018, 1.75,) == approx(-113.008, abs=0.001) 
    assert pressure_loss_from_pipe(0.048692, 200.00, 0.018, 1.75,) == approx(-100.462, abs=0.001) 
    assert pressure_loss_from_pipe(0.286870, 1000.00, 0.013, 1.75,) == approx(-61.576, abs=0.001) 
    assert pressure_loss_from_pipe(0.286870, 1000.00, 0.013, 1.75,) == approx(-110.884, abs=0.001)
