...
def populate_main_window(frm_main):
    ...
    lbl_age = Label(frm_main, text="Radious:")
    lbl_age1d = Label(frm_main, text="n")
    ...
    ent_age1 = IntEntry(frm_main, width=4, lower_bound=60, upper_bound=180)

    # Create a label that displays "years"
    lbl_age_units = Label(frm_main, text="")
    ...
    lbl_rate_units = Label(frm_main, text="M^2")
    ...
    lbl_age1d.grid(      row=0, column=1, padx=10, pady=10)

    ent_age.grid(      row=0, column=1, padx=3, pady=3)
    ent_age1.grid(      row=1, column=0, padx=10, pady=10)
    ...
    def calculate(event):
        ...
        try:
           ...
           # fast = max_rate * 0.85
            ...
            lbl_fast.config(text=f"{area:.0f}")
